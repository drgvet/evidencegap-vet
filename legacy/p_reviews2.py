...
<section>
  <h2>Related</h2>
  <p>The <a href="gapmap.html">gap map</a> places these appraisals in context, mapping twenty-four clinical questions in small-animal cardiology against the strongest evidence available for each. The project runs specialty by specialty across small-animal practice, adding anaesthesia and analgesia, antimicrobials, nutrition and supplements, dermatology and oncology, and all of them are being built out and expanded.</p>
</section>
"""
